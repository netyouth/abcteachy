...
const FeaturedTeachersSection = () => {
  ...
  return (
    <section className="w-full bg-white py-20 relative">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-learning-blue/2 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {teachers.map((teacher, index) => (
            <div key={index} className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 group">
              <div className="text-center mb-4">
                <div className="w-16 h-16 bg-learning-blue-light rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300">
                  <span className="text-3xl">{teacher.avatar}</span>
                </div>
                <h3 className="text-lg font-semibold text-gray-900">{teacher.name}</h3>
                <p className="text-learning-blue font-medium">{teacher.specialty}</p>
              </div>
              ...
              <p className="text-xs text-progress-green text-center mb-4 font-medium">
                {teacher.availability}
              </p>
              
              <Button 
                className="w-full bg-learning-blue hover:bg-learning-blue-dark text-white transition-all duration-200 hover:scale-105"
                size="sm"
              >
                Book Lesson
              </Button>
